...
name_list = ['ap0.50:0.95', 'ap0.50', 'ap0.75', 'aps', 'apm', 'apl', 'ar0.50:0.95[maxDets=1]', 'ar0.50:0.95[maxDets=10]', 'ar0.50:0.95[maxDets=100]', 'ars', 'arm', 'arl']
            ...
            for k in test_stats:
                if self.writer and dist_utils.is_main_process():
                    for i, v in enumerate(test_stats[k]):
                        ...
                        self.writer.add_scalar(f'Test/{k}_{name_list[i]}', v, epoch)
                if k in best_stat:
